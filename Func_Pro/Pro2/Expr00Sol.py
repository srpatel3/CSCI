...
class Sub(Tree):
    ...
    def simplify(self) -> Union[Tree,Var,Const,None]:
        ...
        elif lc and cast(int,cast(Const,sl).value) == 0:
            return sr
        elif rc and cast(int,cast(Const,sr).value) == 0:
            return sl
...
class Neg(Tree):
    ...
    def simplify(self):
        nl = self.val.simplify()  if self.val  else None
        nc= isinstance(nl,Const)
        if nc:
            return Const(-1*nl.value)
...
class Cos(Tree):
    ...
    def simplify(self):
        nl = self.val.simplify()  if self.val  else None
        nc= isinstance(nl,Const)
        if nc and nl.value == 0:
            return Const(1)
        elif nc and nl.value == 90:
            return Const(0)
        elif nc:
            return Const(math.cos(nl.value))
...
class Sin(Tree):
    ...
    def simplify(self):
        ...
        if nc and nl.value == 0:
            ...
            return Const(math.sin(nl.value))
    ...
    def simplify(self):
        ...
        if lc and rc:
            if not sr.value == 0:
                ...
                return None
        elif lc and sl.value == 0:
            return Const(0)
        elif rc and sr.value == 0:
            return None
        elif rc and sr.value == 1:
            return sl
